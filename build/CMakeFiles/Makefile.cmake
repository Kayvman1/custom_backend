...
set(CMAKE_MAKEFILE_DEPENDS
  ...
  "../lib/libpqxx/CMakeLists.txt"
  "../lib/libpqxx/cmake/config.cmake"
  "../lib/libpqxx/cmake/libpqxx-config.cmake"
  "../lib/libpqxx/config-tests/charconv_float.cxx"
  "../lib/libpqxx/config-tests/charconv_int.cxx"
  "../lib/libpqxx/config-tests/cmp.cxx"
  "../lib/libpqxx/config-tests/concepts.cxx"
  "../lib/libpqxx/config-tests/cxa_demangle.cxx"
  "../lib/libpqxx/config-tests/fs.cxx"
  "../lib/libpqxx/config-tests/gcc_pure.cxx"
  "../lib/libpqxx/config-tests/gcc_visibility.cxx"
  "../lib/libpqxx/config-tests/likely.cxx"
  "../lib/libpqxx/config-tests/multidim-subscript.cxx"
  "../lib/libpqxx/config-tests/need_fslib.cxx"
  "../lib/libpqxx/config-tests/sleep_for.cxx"
  "../lib/libpqxx/config-tests/span.cxx"
  "../lib/libpqxx/config-tests/strerror_r.cxx"
  "../lib/libpqxx/config-tests/strerror_s.cxx"
  "../lib/libpqxx/config-tests/thread_local.cxx"
  "../lib/libpqxx/config-tests/unreachable.cxx"
  "../lib/libpqxx/config-tests/year_month_day.cxx"
  "../lib/libpqxx/include/CMakeLists.txt"
  "../lib/libpqxx/libpqxx.pc.in"
  "../lib/libpqxx/src/CMakeLists.txt"
  "../src/CMakeLists.txt"
